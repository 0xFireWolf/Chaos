...
from .CMakeManager import CMakeManager, CMakeBinary
...
class ProjectBuilder:
    def __init__(self, tests: list[str], source_folder: Path, exclude_patterns: list[str], cmake_manager: CMakeManager):
        self.tests = tests
